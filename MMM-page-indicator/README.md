# MagicMirror Module: MMM-page-indicator

A MagicMirror Module for displaying a indicator only. By itself, it only offers a basic way to change the page.

[![Platform](https://img.shields.io/badge/platform-MagicMirror-informational)](https://MagicMirror.builders)

## Example

![Example of MMM-page-indicator](images/example_picture.png)
