# MagicMirror Module: MMM-DynamicWeather

A MagicMirror Module for displaying different animations based on current weather and show customized event effects.
...
![](images/rain_example.png)

**Cloudy**

![](images/cloudy_example.png)
