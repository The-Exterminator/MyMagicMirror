Module.register("MMM-CountDown",{
	...
	getDom: function() {
		...
		var mins = '';
		var secs = '';
		var days = diffDays + this.config.daysLabel + '&nbsp';

		if(this.config.showHours == true) hrs = diffHours + this.config.hoursLabel + '&nbsp';
		if(this.config.showMinutes == true) mins = diffMinutes + this.config.minutesLabel + '&nbsp';
		if(this.config.showSeconds == true) secs = diffSeconds + this.config.secondsLabel + '&nbsp';
